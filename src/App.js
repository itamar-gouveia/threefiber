...
import { useGLTF, Float, QuadraticBezierLine, Backdrop, OrbitControls, Environment, ContactShadows } from '@react-three/drei'
...
export default function App() {
  ...
  return (
    <Canvas dpr={[1, 2]} shadows camera={{ position: [0, 0, 3] }}>
      ...
      <ContactShadows position={[0, -0.485, 0]} opacity={1} width={5} height={5} blur={2} far={1} />
